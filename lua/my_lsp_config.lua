...
local servers = { 'html', 'cssls', 'tsserver', 'emmet_language_server', 'vimls', 'pyright', 'intelephense','clangd','lua_ls','bashls'}
...
require('lspconfig')['emmet_language_server'].setup{
    filetypes = {'php','html','javascriptreact','css','typescript'}
